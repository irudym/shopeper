...
RSpec.describe Director::TypesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all director_types as @director_types" do
      type = Director::Type.create! valid_attributes
      get :index, params: {}, session: valid_session
      expect(assigns(:director_types)).to eq([type])
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new director_type as @director_type" do
      get :new, params: {}, session: valid_session
      expect(assigns(:director_type)).to be_a_new(Director::Type)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Director::Type" do
        expect {
          post :create, params: {director_type: valid_attributes}, session: valid_session
        }.to change(Director::Type, :count).by(1)
      end

      it "assigns a newly created director_type as @director_type" do
        post :create, params: {director_type: valid_attributes}, session: valid_session
        expect(assigns(:director_type)).to be_a(Director::Type)
        expect(assigns(:director_type)).to be_persisted
      end

      it "redirects to the created director_type" do
        post :create, params: {director_type: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Director::Type.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved director_type as @director_type" do
